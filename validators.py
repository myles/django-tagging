...
# 			raise ValidationError(_('Each tag may be no more than %s characters long.') % settings.MAX_TAG_LENGTH)
# 
...
# 		raise ValidationError(_('A tag may be no more than %s characters long.') % settings.MAX_TAG_LENGTH)
